from homematicip.async.device import WallMountedThermostatPro, \
    HeatingThermostat, ShutterContact, SmokeDetector, FloorTerminalBlock6, \
...
TYPE_CLASS_MAP = {HEATING_THERMOSTAT: HeatingThermostat,
                 ...
                 PLUGABLE_SWITCH: PluggableSwitch,
