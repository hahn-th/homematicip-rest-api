...
# from homematicip.securityEvent import SecurityEvent
#
# LOGGER = logging.getLogger(__name__)
#
#
...
#         token = OAuthOTK(self._connection)
#         result = await self._connection.async_post("home/getOAuthOTK")
#         token.from_json(result.json)
#         return token
#
...
#         return await group.delete_async()
#
#     async def set_location(self, city, latitude, longitude):
#         return await self._connection.async_post(
