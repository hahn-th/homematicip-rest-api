...
class DeviceType(AutoNameEnum):
    ...
    CARBON_DIOXIDE_SENSOR = auto()
    COMBINATION_SIGNALLING_DEVICE = auto()
    DALI_GATEWAY = auto()
    ...
    FULL_FLUSH_INPUT_SWITCH_COMPACT = auto()
    ...
    HEATING_THERMOSTAT_COMPACT_PLUS = auto()
    ...
    KEY_REMOTE_CONTROL_KEY_MATIC = auto()
    LIGHT_SENSOR = auto()
    ...
    PARTICULATE_MATTER_SENSOR = auto()
    ...
    STATUS_BOARD_8 = auto()
    SWITCH_MEASURING_CABLE_INDOOR = auto()
    SWITCH_MEASURING_CABLE_OUTDOOR = auto()
    SWITCH_POWER_SUPPLY = auto()
    ...
    TEMPERATURE_SENSOR_2_EXTERNAL_DELTA_PLATIN = auto()
    TEMPERATURE_TILT_VIBRATION_SENSOR = auto()
    TILT_VIBRATION_SENSOR = auto()
    TILT_VIBRATION_SENSOR_COMPACT = auto()
    TORMATIC_MODULE = auto()
    ULTRASONIC_DISTANCE_SENSOR = auto()
    USB_SWITCH_MEASURING = auto()
    WALL_MOUNTED_KEY_PAD = auto()
    WALL_MOUNTED_REMOTE_CONTROL_ROTARY_BUTTON = auto()
    WALL_MOUNTED_GLASS_SWITCH = auto()
    WALL_MOUNTED_GLASS_THERMOSTAT = auto()
    WALL_MOUNTED_GLASS_THERMOSTAT_CARBON = auto()
...
class FunctionalChannelType(AutoNameEnum):
    ...
    TEMPERATURE_SENSOR_CHANNEL = auto()
    TILT_VIBRATION_SENSOR_CHANNEL = auto()
    UNIVERSAL_ACTUATOR_CHANNEL = auto()
    UNIVERSAL_LIGHT_CHANNEL = auto()
    UNIVERSAL_LIGHT_GROUP_CHANNEL = auto()
