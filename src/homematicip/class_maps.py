...
TYPE_CLASS_MAP = {
    ...
    DeviceType.BRAND_SWITCH_MEASURING: SwitchMeasuring,
    ...
    DeviceType.CARBON_DIOXIDE_SENSOR: CarbonDioxideSensor,
    DeviceType.COMBINATION_SIGNALLING_DEVICE: CombinationSignallingDevice,
    DeviceType.DALI_GATEWAY: DaliGateway,
    ...
    DeviceType.DOOR_LOCK_DRIVE_PRO: DoorLockDrivePro,
    DeviceType.DOOR_LOCK_SENSOR: DoorLockSensor,
    DeviceType.ENERGY_SENSORS_INTERFACE: EnergySensorsInterface,
    ...
    DeviceType.FULL_FLUSH_INPUT_SWITCH_COMPACT: FullFlushInputSwitch,
    DeviceType.FULL_FLUSH_LOCK_CONTROLLER: FullFlushLockController,
    DeviceType.FULL_FLUSH_SHUTTER: FullFlushShutter,
    DeviceType.FULL_FLUSH_SWITCH_MEASURING: SwitchMeasuring,
    DeviceType.FULL_FLUSH_WIEGAND_INTERFACE: FullFlushWiegandInterface,
    ...
    DeviceType.HOME_CONTROL_ACCESS_POINT_TWO: HomeControlAccessPoint,
    ...
    DeviceType.KEY_REMOTE_CONTROL_KEY_MATIC: KeyRemoteControlKeyMatic,
    ...
    DeviceType.PARTICULATE_MATTER_SENSOR: ParticulateMatterSensor,
    DeviceType.PASSAGE_DETECTOR: PassageDetector,
    DeviceType.PLUGABLE_SWITCH: PlugableSwitch,
    DeviceType.PLUGABLE_SWITCH_MEASURING: SwitchMeasuring,
    ...
    DeviceType.PUSH_BUTTON_6_LED_SWITCH: PushButton6LedSwitch,
    ...
    DeviceType.TEMPERATURE_SENSOR_2_EXTERNAL_DELTA_PLATIN: TemperatureDifferenceSensor2,
    DeviceType.TEMPERATURE_TILT_VIBRATION_SENSOR: TemperatureTiltVibrationSensor,
    ...
    DeviceType.ULTRASONIC_DISTANCE_SENSOR: UltrasonicDistanceSensor,
    ...
    DeviceType.WALL_MOUNTED_UNIVERSAL_ACTUATOR: WallMountedUniversalActuator,
...
TYPE_FUNCTIONALCHANNEL_MAP = {
    ...
    FunctionalChannelType.ACCESS_CONTROLLER_WIRED_CHANNEL: AccessControllerWiredChannel,
    ...
    FunctionalChannelType.CODE_PROTECTED_PRIMARY_ACTION_CHANNEL: CodeProtectedPrimaryActionChannel,
    FunctionalChannelType.CODE_PROTECTED_SECONDARY_ACTION_CHANNEL: CodeProtectedSecondaryActionChannel,
    FunctionalChannelType.CODE_PROTECTED_SINGLE_ACTION_CHANNEL: CodeProtectedSingleActionChannel,
    ...
    FunctionalChannelType.DEVICE_BLOCKING_WITH_TEACHABLE_CODE: DeviceBlockingWithTeachableCodeChannel,
    ...
    FunctionalChannelType.DEVICE_OPERATIONLOCK_WITH_SABOTAGE: DeviceOperationLockChannelWithSabotage,
    ...
    FunctionalChannelType.DISTANCE_SENSOR_CHANNEL: DistanceSensorChannel,
    FunctionalChannelType.DOOR_CHANNEL: DoorChannel,
    FunctionalChannelType.DOOR_LOCK_CHANNEL: DoorLockChannel,
    FunctionalChannelType.DOOR_LOCK_PRO_CHANNEL: DoorLockProChannel,
    FunctionalChannelType.DOOR_LOCK_SENSOR_BASE_CHANNEL: DoorLockSensorBaseChannel,
    FunctionalChannelType.DOOR_LOCK_SENSOR_CHANNEL: DoorLockSensorChannel,
    FunctionalChannelType.DOOR_SWITCH_CHANNEL: DoorSwitchChannel,
    FunctionalChannelType.MAGNETIC_DOOR_SENSOR_CHANNEL: MagneticDoorSensorChannel,
    ...
    FunctionalChannelType.MULTI_MODE_LOCK_INPUT_CHANNEL: MultiModeLockInputChannel,
    ...
    FunctionalChannelType.NOTIFICATION_MP3_SOUND_CHANNEL: NotificationMp3SoundChannel,
    ...
    FunctionalChannelType.PARTICULATE_MATTER_SENSOR_CHANNEL: ParticulateMatterSensorChannel,
    ...
    FunctionalChannelType.ROTARY_WHEEL_CHANNEL: RotaryWheelChannel,
    ...
    FunctionalChannelType.TEMPERATURE_SENSOR_CHANNEL: TemperatureSensorChannel,
    FunctionalChannelType.TILT_VIBRATION_SENSOR_CHANNEL: TiltVibrationSensorChannel,
    FunctionalChannelType.UNIVERSAL_ACTUATOR_CHANNEL: UniversalActuatorChannel,
    FunctionalChannelType.UNIVERSAL_LIGHT_CHANNEL: UniversalLightChannel,
...
FUNCTIONALCHANNEL_CLI_MAP = {
    ...
    FunctionalChannelType.DOOR_LOCK_PRO_CHANNEL: [CliActions.SET_LOCK_STATE],
