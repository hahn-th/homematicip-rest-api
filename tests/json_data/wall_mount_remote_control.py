    ...
    "events": {
        ...
        "1": {
            ...
            "group": {
                ...
                "channels": [
                    {"deviceId": fake_id, "channelIndex": 2},
                    {"deviceId": fake_id, "channelIndex": 1},
                    {"deviceId": fake_id3, "channelIndex": 1},
                    {"deviceId": fake_id5, "channelIndex": 1},
                ],
                "on": False,
                "dimLevel": None,
                "onTime": 111600.0,
        ...
        "3": {
            ...
            "group": {
                ...
                "type": "META",
                "channels": [
                    {"deviceId": fake_id3, "channelIndex": 0},
                    {"deviceId": fake_id, "channelIndex": 0},
                    {"deviceId": fake_id4, "channelIndex": 0},
                    {"deviceId": fake_id5, "channelIndex": 0},
                    {"deviceId": fake_id6, "channelIndex": 0},
                ],
                "groups": [fake_id7, fake_id2, fake_id8],
            },
        },
    },
    "origin": {"originType": "DEVICE", "id": fake_id},
}
