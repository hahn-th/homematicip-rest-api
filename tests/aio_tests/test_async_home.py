...
# from homematicip.securityEvent import MoistureDetectionEvent, SecurityEvent, SabotageEvent, SensorEvent, \
#     AccessPointConnectedEvent, AccessPointDisconnectedEvent, ActivationChangedEvent
...
#
#         # enable test
#         await rule.enable_async()
#         await rule.set_label_async("ENABLED_RULE")
#         await no_ssl_fake_async_home.get_current_state()
#         rule = no_ssl_fake_async_home.search_rule_by_id(
#             "00000000-0000-0000-0000-000000000065"
#         )
